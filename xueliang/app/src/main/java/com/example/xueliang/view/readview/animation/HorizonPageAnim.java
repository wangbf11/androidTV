package com.example.xueliang.view.readview.animation;
...
public abstract class HorizonPageAnim extends PageAnimation{
    ...
    private boolean edgeClickNext = false; //是否应许左右 两边缘点击 都是 下一页

    public void setEdgeClickNext(boolean edgeClickNext) {
        this.edgeClickNext = edgeClickNext;
    }
